			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					...
					<div class="col-md-6 column">
						<form action="checkLogin.mvc" method="post">
						<div class="form-control" style="height: 235px;">
							<table border="0" cellspacing="0" cellpadding="0" width="100%" colspan="2" >
								...
								<tr><td width="30%">会员名：</td><td width="70%"><input type="text" name="name" class="form-control"/></td></tr>
								<tr><td width="30%">密&nbsp;&nbsp;码：</td><td width="70%"><input id="pw1" name="pwd" type="password" class="form-control"/></td></tr>
							</table>
							<br/><span><font color="red">${status }</font></span><br/>
